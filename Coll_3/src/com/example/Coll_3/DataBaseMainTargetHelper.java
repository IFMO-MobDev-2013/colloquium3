 ...
 */
public class DataBaseMainTargetHelper extends SQLiteOpenHelper {
	public static final String NAME_DATABASE = "db_main_target";
	public static final int VERSION_DATABASE = 1;
	public static final String NAME_TABLE = "table_main_target";
	public static final String TARGET = "target";
	public static final String PRIORY = "priory";

	public DataBaseMainTargetHelper(Context context) {
